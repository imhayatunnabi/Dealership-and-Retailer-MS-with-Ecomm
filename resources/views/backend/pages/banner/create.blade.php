...
@section('content')
<h5 class="text-primary text-center mb-5">Create Banner</h5>
<form action="{{ route('backend.banner.store') }}" method="post" enctype="multipart/form-data" class="form-group">
    @csrf
    <div class="mb-3">
